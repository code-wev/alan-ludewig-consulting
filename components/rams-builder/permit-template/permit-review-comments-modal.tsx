...
export function PermitReviewCommentsModal({ onClose }: PermitReviewCommentsModalProps) {
  return (
            ...
            <div className="flex flex-col gap-6 h-full overflow-hidden">
              ...
              <div className="flex flex-col lg:flex-row h-full overflow-hidden border border-[#e3e6ec] rounded-[12px]">
                ...
                <div className="bg-[#f3f5f8] border-r border-[#e3e6ec] lg:w-68 shrink-0 p-6 flex flex-col gap-6 overflow-y-auto">
                  <h3 className="text-[16px] font-bold text-brand-primary">Review History</h3>
                  ...
                  <div className="flex flex-col gap-8 relative ml-2.75">
                    ...
                    <div className="flex items-start gap-4 relative z-10">
                      ...
                      <div className="flex flex-col">
                        <span className="text-[14px] text-brand-primary">Review Rejected</span>
                        <span className="text-[12px] text-brand-secondary mt-1">Today, 10:45 AM</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 relative z-10">
                      ...
                      <div className="flex flex-col">
                        <span className="text-[14px] text-brand-primary">Reviewer Assigned</span>
                        <span className="text-[12px] text-brand-secondary mt-1">Yesterday</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 relative z-10">
                      ...
                      <div className="flex flex-col">
                        <span className="text-[14px] text-brand-primary">Submitted for Approval</span>
                        <span className="text-[12px] text-brand-secondary mt-1">Oct 24</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 relative z-10">
                      ...
                      <div className="flex flex-col">
                        <span className="text-[14px] text-brand-primary">Draft Created</span>
                        <span className="text-[12px] text-brand-secondary mt-1">Oct 22</span>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="bg-white border border-[#e3e6ec] rounded-[12px] drop-shadow-[0px_4px_10px_rgba(0,0,0,0.05)] p-4.25 flex flex-col gap-5">
                      <div className="flex gap-4">
                        ...
                        <div className="flex flex-col w-full gap-1">
                          <div className="flex items-center justify-between w-full">
                            <span className="font-semibold text-[#001137] text-[16px]">Marcus Chen</span>
                            <span className="text-[#505e7c] text-[13px]">Today, 10:48 AM</span>
                          </div>
                          <div className="text-[14px] text-[#191c1e] leading-5">
                            The permit type selected is <span className="text-[#001137]">&apos;Standard Hot Work&apos;</span>, but the job description mentions working near high-pressure gas lines. This <span className="text-[#ba1a1a]">MUST</span> be upgraded to &apos;High Risk Restricted Area&apos; to comply with site safety protocols.
                          </div>
                        </div>
                      </div>
                      <div className="border-t border-[#e3e6ec] flex justify-end pt-2.25 mt-2">
                        <button className="flex items-center gap-1 hover:bg-slate-50 px-2 py-1 rounded">
                          ...
                          <span className="text-[14px] text-brand-primary">Reply</span>
                        </button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-5">
                        ...
                        <h3 className="text-[16px] font-bold text-brand-primary">Hazard Identification</h3>
                      </div>
                      <span className="bg-[#ffdad6] text-[#d92d20] text-[12px] px-2 py-0.5 rounded-[3px]">
                        Unresolved
                      </span>
                    ...
                    <div className="bg-white border border-[#e3e6ec] rounded-[12px] drop-shadow-[0px_4px_10px_rgba(0,0,0,0.05)] p-4.25 flex flex-col gap-5">
                      <div className="flex gap-4">
                        ...
                        <div className="flex flex-col w-full gap-1">
                          <div className="flex items-center justify-between w-full">
                            <span className="font-semibold text-[#001137] text-[16px]">Marcus Chen</span>
                            <span className="text-[#505e7c] text-[13px]">Today, 10:52 AM</span>
                          </div>
                          <div className="text-[14px] text-[#191c1e] leading-5">
                            Atmospheric monitoring requirements are incomplete. Given the confined space proximity, you must specify the frequency of gas testing and the specific gases being monitored (LEL, H2S, O2).
                          </div>
                        </div>
                      </div>
                      <div className="border-t border-[#e3e6ec] flex justify-end pt-2.25 mt-2">
