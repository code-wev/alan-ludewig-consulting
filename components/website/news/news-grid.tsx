...
const newsItems = [
  {
    ...
    date: "2 May 2026",
    description:
      "The Health and Safety Executive has issued revised guidance on CDM 2015 obligations for contractors working on smaller domestic and commercial projects.",
  ...
  },
  {
    ...
    date: "18 Apr 2026",
    description:
      "New enforcement priorities around respirable crystalline silica mean that site supervisors must review existing dust controls and update COSHH assessments before summer.",
  ...
  },
  {
    ...
    date: "5 Apr 2026",
    description:
      "A Midlands-based groundworks contractor shares how a retained health & safety service transformed their compliance culture and reduced near-miss reports.",
  ...
  },
  {
    ...
    date: "22 Mar 2026",
    description:
      "Upcoming changes to RIDDOR reporting thresholds will affect how businesses log and report work-related injuries. Here's what you need to do before the deadline.",
  ...
  },
  {
    ...
    date: "10 Mar 2026",
    description:
      "With the Fire Safety Act now fully in force, we look at the practical steps building owners and principal contractors must take to remain compliant.",
  ...
  },
  {
    ...
    date: "1 Mar 2026",
    description:
      "We've released six new toolbox talk resources covering excavation safety, working at height, and manual handling — free to download for all registered members.",
