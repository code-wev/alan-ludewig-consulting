import { Search, Target, Wrench, FolderOpen } from "lucide-react";

const steps = [
  {
    num: "1",
    title: "Understand Your Requirements",
    description: "We identify your business, project, documentation or support needs.",
    iconBg: "bg-[#e8eaee]",
    icon: <Search className="w-5 h-5 text-[#132651]" />
  },
  {
    num: "2",
    title: "Review Risks and Priorities",
    description: "We help assess where support is needed and what actions matter most.",
    iconBg: "bg-[#eff6ff]",
  ...
  },
  {
    ...
    description: "We deliver advice, documents, inspections, training or retained support.",
    iconBg: "bg-[#ccfbf1]",
    icon: <Wrench className="w-5 h-5 text-[#0f766e]" />
  },
  {
    num: "4",
    title: "Keep You Organised",
    description: "Through retained services and the member portal, support and documents stay easier to manage.",
    iconBg: "bg-[#ede9fe]",
    icon: <FolderOpen className="w-5 h-5 text-[#7c3aed]" />
  }
];
    ...
    <section className="bg-[#f7f8fa] w-full py-[100px]">
      <div className="mx-auto max-w-[1760px] px-4 md:px-20 flex flex-col items-center gap-[60px]">
        ...
        <div className="flex flex-col gap-[24px] items-center text-center">
          <h2 className="text-[40px] font-bold text-[#132651] leading-[1.2] max-w-[680px]">
            A Practical Approach to Health & Safety Support
          </h2>
          <p className="text-[16px] text-[#5a6886] leading-[1.6] max-w-[679px]">
            Our process is designed to keep advice clear, suitable and focused on your business needs.
          </p>
        </div>
