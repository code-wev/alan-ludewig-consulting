          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1">
              ...
              <textarea
                ...
                className="mt-1.5 w-full h-[90px] p-3 border-[1.5px] border-[#DCE0E7] bg-white rounded-[6px] text-[13.5px] text-[#132651] outline-none focus:border-[#132651] placeholder:text-[#A3ACBA] transition resize-none"
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="mt-1.5 w-full h-[51px] px-4 border-[1.5px] border-[#DCE0E7] bg-white rounded-[6px] text-[13.5px] text-[#132651] outline-none focus:border-[#132651] placeholder:text-[#A3ACBA] transition"
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <textarea
                ...
                className="mt-1.5 w-full h-[78px] p-3 border-[1.5px] border-[#DCE0E7] bg-white rounded-[6px] text-[13.5px] text-[#132651] outline-none focus:border-[#132651] placeholder:text-[#A3ACBA] transition resize-none"
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-[13px] text-[#5A6886] font-inter leading-[1.4]">
                Add any project-specific information that affects the method of work
              </span>
              <textarea
      ...
      <div className="col-span-12 lg:col-span-4 flex flex-col gap-5">
        ...
        <div className="flex flex-col p-5 bg-[#E8F0FE] border border-[#ADC6FF]/30 rounded-[12px] gap-3">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-[13.5px] font-bold text-[#132651] font-inter">Reminder</h4>
          </div>

          <p className="text-[13px] leading-[1.65] text-[#132651] font-inter">
            Keep the scope clear and site-specific. Include only work activities relevant
            to this method statement. Avoid generic descriptions that could apply to any site.
          </p>

          <ul className="flex flex-col gap-1.5 text-[13px] text-[#132651] font-inter">
            <li className="flex items-start gap-2">
              <span className="mt-[5px] size-1.5 rounded-full bg-[#132651] shrink-0" />
        ...
        <div className="flex flex-col p-6 bg-white border border-[#E3E6EC]/60 rounded-[16px] shadow-[0_10px_30px_rgba(0,0,0,0.02)] gap-5">
          <h4 className="text-[18px] font-bold text-[#132651] font-inter">Document Progress</h4>

          <div className="flex flex-col gap-0">

            {/* Project Details — completed */}
            <div className="flex items-center justify-between py-3 border-b border-[#F3F5F8]">
              <span className="text-[14px] text-[#5A6886] font-inter">Project Details</span>
            ...
            <div className="flex items-center justify-between py-3 border-b border-[#F3F5F8]">
              <span className="text-[14px] font-bold text-[#132651] font-inter">Scope of Works</span>
              {/* Radio-active circle */}
            ...
            <div className="flex items-center justify-between py-3 border-b border-[#F3F5F8] opacity-50">
              <span className="text-[14px] text-[#5A6886] font-inter">Sequence of Works</span>
            ...
            <div className="flex items-center justify-between py-3 opacity-50">
              <span className="text-[14px] text-[#5A6886] font-inter">Risk Assessment</span>
              <div className="size-5 rounded-full border border-[#C8CDD8]" />
            </div>
          ...
          <button
            type="button"
            onClick={onSaveDraft}
            className="h-[38px] w-full rounded-[8px] border border-[#DCE0E7] bg-white text-[#132651] text-[13px] font-semibold transition hover:bg-[#F3F5F8] cursor-pointer"
          >
            Preview Draft
          </button>
        </div>
