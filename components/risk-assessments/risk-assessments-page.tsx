    ...
    <div className="flex flex-col gap-10 w-full max-w-[1664px] mx-auto pb-10">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-1.5 text-xs text-[#5A6886] font-sans">
          ...
          <ChevronRight className="w-3.5 h-3.5" />
          <span className="text-[#132651]">Risk Assessment Templates</span>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-6 mt-[-16px]">
        ...
        <div className="flex flex-col lg:flex-row justify-between lg:items-center gap-6">
          <div className="flex flex-col gap-2 max-w-[1327px]">
            <h1 className="text-[30px] font-bold text-[#132651] leading-tight font-sans">Risk Assessment Templates</h1>
          ...
          <div className="flex items-center gap-3 shrink-0">
            <Button 
              ...
              className="h-[34px] px-4 bg-[#132651] text-white font-bold hover:bg-[#132651]/90 rounded-md"
            >
              Create Custom RA
            </Button>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-[#D6E9FF] border-b-[1.5px] border-[#F3F5F8]">
                  ...
                  <th className="py-3 px-6 text-sm font-bold text-[#132651] whitespace-nowrap">Format</th>
                  <th className="py-3 px-6 text-sm font-bold text-[#132651] whitespace-nowrap">Version</th>
        ...
        <div className="flex flex-col items-center justify-center gap-4 py-10 mt-6">
          ...
          <Button 
            onClick={() => setIsModalOpen(true)}
            variant="outline" 
            className="h-[34px] px-4 border-[#132651] text-[#132651] font-bold hover:bg-slate-50 rounded-md"
          >
...
function TableRow({ name, format, version, date, status }: { name: string, format: string, version: string, date: string, status: string }) {
  ...
  return (
    <tr className="border-b-[1.5px] border-[#F3F5F8] last:border-0 hover:bg-slate-50/50 transition-colors">
      <td className="py-4 px-6 text-sm text-[#132651] font-sans">
